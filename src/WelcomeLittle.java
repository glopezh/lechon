...
public class WelcomeLittle extends javax.swing.JFrame {
    ...
    public void llenar_arreglo() {
        cadena[0] = "Gracias por las clases :D te quelo, ya me gusto esto aahahaha";
        cadena[1] = "No se si te lo han dicho antes,Pero después de haber comido en tantos restaurantes";
        cadena[2] = "Los mas caros, más ricos, más finos y más elegantes";
        cadena[3] = "Despues de viajar por los sitios más extravagantes";
        cadena[4] = "Descubrí";
        cadena[5] = "Que tu cuerpo es mi lugar favorito";
        cadena[6] = "Y tu boca mi comida favorita";
    ...
    public String obtener_momento() {
        ...
        if ((hora >= 19) && (hora < 24)) {
            mensaje = "Buenas noches LuisMimimimimi";
            cambiar_fondo("/imagenes/fondo1.jpg");
        }
        return mensaje;
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Created by XXX CopyRight - All Rights Reserved");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(20, 400, 300, 12);

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Foto:", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Berlin Sans FB", 1, 12))); // NOI18N
